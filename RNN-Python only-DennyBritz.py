# -*- coding: utf-8 -*-
"""
Created on Thu Aug 18 10:00:07 2016
...
# word_dim: size of our vocabulary - 8000
#hidden_dim: no. of hidden layers - 100
...
# Find the most likely next word based on prediction
...
# Calculate baseline loss. Limit to 1000 examples to save time
...
## Implement gradient checking to check if bptt is working. Complicated math
...
## Since we can perform gradient checking, we can now implement SGD
...
## Done! Let's try to get a sense of how long it would take to
## train our network:
